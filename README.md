...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ohx5tfe.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ohx5tfe.containers.anotherwebservice.com/
...
```
git clone git@github.com:chrisjsimpson/container-ohx5tfe.git
cd container-ohx5tfe
```
...
```
docker attach container-ohx5tfe
```
